...
namespace aho_corasick {
	...
	private:
        ...
        int                         max_length;
        BilinearMapKey              keyset;
        vector<vector<reference_wrapper<Scalar>>> scalar_sets;
	...
	public:
        ...
        void construct_acc() {
            ...
            BilinearMapAccumulator::genKey(scalar_sets,max_length,keyset,threadPool);
